...
export default function StaffCourseDetailPage() {
  ...
  const handleCreateContent = () => {
    router.push(`/staff/courses/${courseId}/content/new`)
  }
  ...
  const handleViewSubmissions = (assignmentId: string) => {
    router.push(`/staff/courses/${courseId}/assignments/${assignmentId}/submissions`)
  }
    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          ...
          <Link href="/staff/courses" className="text-blue-600 hover:text-blue-500">
            ← Back to Courses
          </Link>
        </div>
      </div>
                  ...
                  <div key={lesson.id} className="bg-white rounded-lg shadow-sm border p-6">
                    <div className="flex items-start justify-between">
                      ...
                      <div className="flex items-center space-x-2 ml-4">
                        ...
                        <button
                          onClick={() => router.push(`/staff/courses/${courseId}/content/${lesson.id}`)}
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <button
                    onClick={() => {
                      ...
                      router.push(`/staff/courses/${courseId}/students`)
                    }}
                    className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg text-sm font-medium"
                  >
                    Manage Enrollments
              ...
              <div className="space-y-4">
                ...
                {[
                  ...
                  <div key={student.id} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg border">
                    ...
                    <div className="flex items-center space-x-4">
                      ...
                      <button
                        onClick={() => router.push(`/staff/users/${student.id}`)}
                        className="text-blue-600 hover:text-blue-500 text-sm font-medium"
                      >
                        View Profile
                      </button>
                ...
                {course.enrolledStudents === 0 && (
                  <div className="text-center py-12">
                    ...
                    <button
                      onClick={() => router.push(`/staff/courses/${courseId}/students`)}
                      className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg text-sm font-medium"
                    >
                      Add Students
                    </button>
