...
export default function ImprovedLayout({ children, navigation, userRole }: ImprovedLayoutProps): JSX.Element {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Sidebar */}
      <div className={`fixed inset-y-0 left-0 z-50 ${sidebarWidth} bg-white shadow-lg transform transition-all duration-300 ease-in-out lg:translate-x-0 ${
